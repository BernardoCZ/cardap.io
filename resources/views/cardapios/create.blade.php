        ...
        <div class="modal-body">
            <form method="post" action="{{ route('cardapios.gravar') }}" id="criar-cardapio-form">
                ...
                <div class="form-floating mb-3">
                    <input type="number" class="form-control visually-hidden" id="id_estabelecimento" name="id_estabelecimento" value="{{ $id_estabelecimento }}">
                        ...
                        <div class="col">
                            <div class="p-3 mb-3 rounded d-flex shadow cardapio-titulo-div" id="preview-cardapio-titulo-div">
                                <div class="m-auto reticencias">
                                    <h2 class="h4 cardapio-titulo mb-0 reticencias" id="preview-cardapio-titulo">Nome</h2>
                                </div>
                            </div>
                        </div>
                    </div>
